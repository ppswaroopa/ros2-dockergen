...
class GeneratorCore:
    ...
    def build_dockerfile(self, config):
        ...
        ln(f"# Generated by ros2-docker-gen v{self._cfg['version']}")
        ln("# =============================================================")
        gap()
    ...
    def build_compose(self, config):
        ...
        ln(f"# docker-compose.yml — generated by ros2-docker-gen v{self._cfg['version']}")
        ln("services:")
        ln(f"  {container_name}:")
        ln("    build:")
        ln("      context: .")
...
Generated by **ros2-docker-gen v{self._cfg['version']}**
